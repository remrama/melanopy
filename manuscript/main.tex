...
(\textbf{Melanopy} ships a CVD-safe qualitative palette for this case --- optimised for category separability, not melanopic content; it stays well-separated under simulated colour blindness, Fig.~\ref{fig:melanopic-colormaps}.)
